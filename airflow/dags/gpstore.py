...
with DAG(
    ...
    data_fourth = BashOperator(task_id='data_fourth',
                            bash_command="cd /home/art/gitprj/MLopsXFlow/ && python /home/art/gitprj/MLopsXFlow/scripts/data_fourth.py", 
                            dag=dag)
    data_fifth = BashOperator(task_id='data_fifth',
                            bash_command="cd /home/art/gitprj/MLopsXFlow/ && python /home/art/gitprj/MLopsXFlow/scripts/data_fifth.py", 
                            dag=dag)
    data_six = BashOperator(task_id='data_six',
                            bash_command="cd /home/art/gitprj/MLopsXFlow/ && python /home/art/gitprj/MLopsXFlow/scripts/data_six.py", 
                            dag=dag)
